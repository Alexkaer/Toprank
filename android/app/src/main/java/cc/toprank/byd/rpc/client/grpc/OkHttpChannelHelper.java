package cc.toprank.byd.rpc.client.grpc;
...
/**
 * Created by bwang on 2016/7/1.
 *
 * A helper class to create a OkHttp based channel.
 */
    public class OkHttpChannelHelper {

        private OkHttpChannelHelper(){
            //do nothing.
        }
         ...
         *
         * @return the instance of OkHttpChannelHelper
         */
        public static OkHttpChannelHelper getInstance() {
            return Loader.INSTANCE;
        }

        private static class Loader {
            private static final OkHttpChannelHelper INSTANCE = new OkHttpChannelHelper();
        ...
        private static SSLSocketFactory getSslSocketFactory(
                @Nullable InputStream testCa) throws Exception {
            if (testCa == null) {
        ...
        private static SSLCertificateSocketFactory getSslCertificateSocketFactory(
                @Nullable InputStream testCa, String androidSocketFatoryTls)
                throws Exception {
		 /*
		 * API level 14
		 */
        ...
        private static TrustManager[] getTrustManagers(InputStream testCa)
                throws Exception {
